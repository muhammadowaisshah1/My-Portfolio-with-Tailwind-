...
const HomePage: React.FC<HomePageProps> = ({ profileImageSrc = "/New folder/profile-picture.jpg", name = "Muhammad Owais Shah", description = "I'm Enthusiastic frontend developer focused on creating intelligent and dynamic web applications. Currently diving into the world of AI agent development, I'm learning to build systems that drive innovation and automation." }) => {
  return (
